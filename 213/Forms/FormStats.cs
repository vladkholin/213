    ...
    public partial class FormStats : Form
    {
        ...
        public class DBOperation
        {
            ...
            public void GetListStaff(BindingSource bs1, DataGridView dg1)
            {
                ...
                string commandStr = "SELECT id AS 'ID', type AS 'Тип', name AS 'Название', count AS 'Количество' FROM statistic";
            ...
            public void InsertStaff(TextBox textBox1, TextBox textBox2, TextBox textBox3, TextBox textBox4)
            {
                ...
                string new_count = textBox4.Text;

                if (textBox1.Text.Length > 0)
                {
                    //Формируем строку запроса на добавление строк
                    string sql_insert_clothes = " INSERT INTO `statistic` (id, type,name,count) " +
                        "VALUES ('" + new_id + "', '" + new_type + "', '" + new_name + "', '" + new_count + "')";
            ...
            public void UpdateStaff(TextBox textBox1, TextBox textBox2, TextBox textBox3, TextBox textBox4)
            {
                ...
                string SQL_izm = "UPDATE statistic SET id=N'" + textBox1.Text + "', type=N'" + textBox2.Text + "', name=N'" + textBox3.Text + "'," +
                    " count=N'" + textBox4.Text + "' where id=" + id;
